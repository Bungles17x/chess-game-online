...
// Override the updateXPDisplay function in achievements-display-fix.js
setTimeout(function fixAchievementsXP() {
  if (typeof updateXPDisplay === 'function') {
    ...
    window.updateXPDisplay = function() {
      ...
      console.log('[Achievements XP Fix] currentUser:', currentUser);
      console.log('[Achievements XP Fix] currentUser.xp:', currentUser?.xp);
      console.log('[Achievements XP Fix] currentUser.level:', currentUser?.level);
      ...
      console.log('[Achievements XP Fix] Calculated values:', { totalXP, currentLevel, xpInCurrentLevel, xpNeeded, progress });
      ...
      console.log('[Achievements XP Fix] Updated XP display', { totalXP, currentLevel, xpInCurrentLevel, xpNeeded, progress });
    };

    console.log('[Achievements XP Fix] Successfully fixed updateXPDisplay function');
  } else {
    console.warn('[Achievements XP Fix] updateXPDisplay function not available yet');
  }
}, 1500);

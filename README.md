...
<svg xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="0" y="60" font-size="16">
    merge, publish, distribute, sublicense, and/or sell copies of the Software.
  </text>
  <text x="0" y="80" font-size="16">
    Conditions:
  </text>
  <text x="0" y="100" font-size="16">
    1: you must use a different folder.
  </text>
  <text x="0" y="120" font-size="16">
    2: you must use appropriate actions or you may get into trouble with the law.
  </text>
  <text x="0" y="140" font-size="16">

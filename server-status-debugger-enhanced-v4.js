// Server Status Debugger - Enhanced Version v4
...
function toggleErrorExplanation(errorKey) {
...
function updateDebuggerStats() {
  const totalElement = document.getElementById('debugger-total-count');
  const errorElement = document.getElementById('debugger-error-count');
  const warningElement = document.getElementById('debugger-warning-count');
  const infoElement = document.getElementById('debugger-info-count');

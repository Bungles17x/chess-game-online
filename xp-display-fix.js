...
// Override the updateXPDisplay function to show correct progress
setTimeout(function fixXPDisplay() {
  if (typeof updateXPDisplay === 'function') {
    ...
    window.updateXPDisplay = function() {
      ...
      console.log('[XP Display Fix] currentUser:', currentUser);
      console.log('[XP Display Fix] currentUser.xp:', currentUser?.xp);
      console.log('[XP Display Fix] currentUser.level:', currentUser?.level);
      ...
      console.log('[XP Display Fix] Calculated values:', { totalXP, currentLevel, xpInCurrentLevel, xpNeeded, progress });
      ...
      console.log('[XP Display Fix] Updated XP display', { totalXP, currentLevel, xpInCurrentLevel, xpNeeded, progress });
    };

    console.log('[XP Display Fix] Successfully fixed updateXPDisplay function');
  } else {
    console.warn('[XP Display Fix] updateXPDisplay function not available yet');
  }
}, 1000);
